...
"""SCP11-test session factory: constructs the simulated-card channel, provider, and crypto-engine for test sessions."""
# -----------------------------------------------------------------------------
...
try:
    ...
    from ..live.transport import PcscApduChannel
except ImportError:
    from es9_client import Es9LikeClient
    from models import (
        BACKEND_MODE_LOCAL_SGP26,
