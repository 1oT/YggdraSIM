...
class HelpMenu :
    ...
    def print_help ()->None :
        ...
        print (f"{Config.Colors.WARNING}Note: Admin secure channel support covers SCP03 and SCP02 for Security Domain authentication. SCP11 provisioning and relay flows live in the dedicated SCP11 modules.{Config.Colors.ENDC}")
