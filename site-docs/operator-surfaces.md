...
| `Tools/HilBridge/` | a live card must be bridged to a modem through SIMtrace2 | HIL bridge, supervisor lifecycle, GSMTAP mirroring, APDU side-channel access | `python -m Tools.HilBridge.supervisor` |
