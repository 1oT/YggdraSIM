...
| Script | Purpose |
| --- | --- |
| `mirror_source_docs.py` | Mirror authored source docs from `guides/`, the public `plugins/README.md`, `SCP11/`, `tests/`, and root text pages into `site-docs/sources/`, and rebuild the `site-docs/source-library.md` index. Private runtime-plugin subtrees are excluded. |
