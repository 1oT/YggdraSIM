...
- The hardcoded identity sheet for the bundled fake eIM:
  [`Workspace/LocalEIM/certs/addeim/SIMULATED_EIM_IDENTITY.md`](https://github.com/hampushellsberg-dev/YggdraSIM/blob/main/Workspace/LocalEIM/certs/addeim/SIMULATED_EIM_IDENTITY.md)
