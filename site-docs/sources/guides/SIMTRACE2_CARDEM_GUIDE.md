...
[`HIL_BRIDGE_GUIDE.md`](https://github.com/1oT/YggdraSIM/blob/main/guides/HIL_BRIDGE_GUIDE.md) for the operator flow once
...
- [`HIL_BRIDGE_GUIDE.md`](https://github.com/1oT/YggdraSIM/blob/main/guides/HIL_BRIDGE_GUIDE.md) -- operator flow.
- [`INSTALL_FULL.md`](https://github.com/1oT/YggdraSIM/blob/main/guides/INSTALL_FULL.md) -- HIL-capable executable install.
- [`INSTALL_RASPBERRYPI.md`](https://github.com/1oT/YggdraSIM/blob/main/guides/INSTALL_RASPBERRYPI.md) -- Pi-specific HIL notes.
